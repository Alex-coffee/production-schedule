function productStaticCtrl($scope, $q, $modal, productStaticServices){
    $scope.dataList = [];
    ...
    function loadData(){
        ...
        productStaticServices.getProductStaticData().then(function(result){
...
angular
.module('piApp')
.controller('productStaticCtrl', productStaticCtrl)
;